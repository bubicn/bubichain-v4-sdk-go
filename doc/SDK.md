...
- **Request parameters**
   ...
   gasPrice|int64|Required, transaction gas price, unit UGas, 1 Gas = 10^8 UGas, size limit [1000, max(int64)]
   feeLimit|int64|Required, the minimum fees required for the transaction, unit UGas, 1 Gas = 10^8 UGas, size limit [1, max(int64)]
...
| gasPrice    | int64 | Transaction fuel price, unit UGas, 1 Gas = 10^8 UGas |
